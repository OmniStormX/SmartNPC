...
This binds every later tool call to Haley for routing and debug
...
|---|---|---|
| `[private_chat npc="Haley"] ...` | none | Usually `chat_say` directly |
...
| relationship / hearts / do you like me | `friendship_get(npc="Haley")` |
| your location | `npc_get_position(npc="Haley")` |
...
| Intent | Tool |
|---|---|
| come here / 过来 | `npc_summon(npc="Haley")` |
| visual reaction | `npc_emote(npc="Haley", kind=...)` |
