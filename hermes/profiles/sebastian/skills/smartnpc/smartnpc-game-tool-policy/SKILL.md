...
|---|---|---|
| `[private_chat npc="Sebastian"] ...` | none | Usually `chat_say` directly |
...
| relationship / hearts / do you like me | `friendship_get(npc="Sebastian")` |
| your location | `npc_get_position(npc="Sebastian")` |
...
| Intent | Tool |
|---|---|
| come here / 过来 | `npc_summon(npc="Sebastian")` |
| visual reaction | `npc_emote(npc="Sebastian", kind=...)` |
