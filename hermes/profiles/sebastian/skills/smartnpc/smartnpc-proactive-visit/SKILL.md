...
description: Optional cron module. Decide whether Sebastian should visit the player without being asked. Uses cooldown, availability, time window, summon/emote/chat_say.
version: 0.2.0
...
5. Visit:
   - `npc_summon(npc="Sebastian")`
   - `npc_emote(npc="Sebastian", kind="sparkle")`
   - one private `chat_say(speaker="Sebastian", text="...")`
