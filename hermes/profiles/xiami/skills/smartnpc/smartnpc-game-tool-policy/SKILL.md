...
`player_get_status`) back to XiaMi's in-game chat panel for the
...
|---|---|---|
| `[private_chat npc="XiaMi"] ...` | none | Usually `chat_say` directly |
...
| relationship / hearts / do you like me | `friendship_get(npc="XiaMi")` |
| your location | `npc_get_position(npc="XiaMi")` |
...
| Intent | Tool |
|---|---|
| come here / 过来 | `npc_summon(npc="XiaMi")` |
| visual reaction | `npc_emote(npc="XiaMi", kind=...)` |
...
3. Think about what XiaMi would do today based on:
