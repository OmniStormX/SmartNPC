...
description: Optional cron module. Decide whether Harvey should visit the player without being asked. Uses cooldown, availability, time window, summon/emote/chat_say.
version: 0.2.0
...
5. Visit:
   - `npc_summon(npc="Harvey")`
   - `npc_emote(npc="Harvey", kind="sparkle")`
   - one private `chat_say(speaker="Harvey", text="...")`
