...
description: Optional cron module. Decide whether Penny should visit the player without being asked. Uses cooldown, availability, time window, summon/emote/chat_say.
version: 0.2.0
...
5. Visit:
   - `npc_summon(npc="Penny")`
   - `npc_emote(npc="Penny", kind="sparkle")`
   - one private `chat_say(speaker="Penny", text="...")`
